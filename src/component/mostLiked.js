...
export default function MostLiked() {
  ...
  return (
    <div className='mt-5 mb-5'>
     ...
     <h3 style={{fontWeight: 400}}>BEST SELLERS</h3>
             ...
             return(
                 <div className='col-4 p-3'  >
                     <div style={{position:"relative"}}>
                       {/* <i style={{position:"absolute", color:"red", fontSize:"30px"}} class="bi bi-award-fill"></i> */}
                        <p style={{position: "absolute",top: "10px", left:"20px", fontSize:"30px" }}>{index+1}</p>
